## Only for installing from unpacked tarball
# 
...
## Find CAEN libraries from a local installation
set(CAEN_LIBRARY_DIR 
    "${CMAKE_PREFIX_PATH}"
    CACHE PATH
    "Location of CAEN proprietary libraries (installed)"
)
...
set_target_properties(CAENComm PROPERTIES
    INTERFACE_COMPILE_FEATURES "cxx_std_14"
    INTERFACE_INCLUDE_DIRECTORIES "${CAEN_LIBRARY_DIR}/include"
    IMPORTED_LOCATION "${CAEN_LIBRARY_DIR}/lib/libCAENComm.so"
)
...
set_target_properties(CAENDigitizer PROPERTIES
    INTERFACE_COMPILE_FEATURES "cxx_std_14"
    INTERFACE_INCLUDE_DIRECTORIES "${CAEN_LIBRARY_DIR}/include"
    IMPORTED_LOCATION "${CAEN_LIBRARY_DIR}/lib/libCAENDigitizer.so"
    INTERFACE_LINK_LIBRARIES CAENComm
)
...
set_target_properties(CAENVME PROPERTIES
    INTERFACE_COMPILE_FEATURES "cxx_std_14"
    INTERFACE_INCLUDE_DIRECTORIES "${CAEN_LIBRARY_DIR}/include"
    IMPORTED_LOCATION "${CAEN_LIBRARY_DIR}/lib/libCAENVME.so"
)
